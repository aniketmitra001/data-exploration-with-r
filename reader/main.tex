...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: Must subset rows with a valid subscript vector.\\\#\# [34mi[39m Logical subscripts must match the size of the indexed input.\\\#\# [31mx[39m Input has size 1229805 but subscript `fiveStarRestaurants \%in\% attribute\$business\_id` has size 1366.}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'attributeCount' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'sortedAttributeCount' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in barplot(sortedAttributePercent[sortedAttributePercent > 1], horiz = TRUE, : object 'sortedAttributePercent' not found}}\begin{alltt}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleansedBusiness\$status\_char` is discouraged. Use `status\_char` instead.}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleansedBusiness\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleansedBusiness\$review\_count` is discouraged. Use `review\_count` instead.}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `businesses\_top10Merged\$stars` is discouraged. Use `stars` instead.}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `businesses\_top10Merged\$stars` is discouraged. Use `stars` instead.}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `businesses\_top10Merged\$centered\_ratings` is discouraged. Use `centered\_ratings` instead.}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `businesses\_top10Merged\$rating\_categorization` is discouraged. Use `rating\_categorization` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `businesses\_top10Merged\$category` is discouraged. Use `category` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `businesses\_top10Merged\$centered\_ratings` is discouraged. Use `centered\_ratings` instead.}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$numCheckins\_Monday` is discouraged. Use `numCheckins\_Monday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$numCheckins\_Tuesday` is discouraged. Use `numCheckins\_Tuesday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$numCheckins\_Wednesday` is discouraged. Use `numCheckins\_Wednesday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$numCheckins\_Thursday` is discouraged. Use `numCheckins\_Thursday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$numCheckins\_Friday` is discouraged. Use `numCheckins\_Friday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$numCheckins\_Saturday` is discouraged. Use `numCheckins\_Saturday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `trainingSet\$numCheckins\_Sunday` is discouraged. Use `numCheckins\_Sunday` instead.}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$numCheckins\_Monday` is discouraged. Use `numCheckins\_Monday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$numCheckins\_Tuesday` is discouraged. Use `numCheckins\_Tuesday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$numCheckins\_Wednesday` is discouraged. Use `numCheckins\_Wednesday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$numCheckins\_Thursday` is discouraged. Use `numCheckins\_Thursday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$numCheckins\_Friday` is discouraged. Use `numCheckins\_Friday` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$stars` is discouraged. Use `stars` instead.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Use of `cleanedTrainingSet\$numCheckins\_Saturday` is discouraged. Use `numCheckins\_Saturday` instead.}}
